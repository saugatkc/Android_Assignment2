package com.saugat.recylerviewpresidentus.Adapter;
...
import com.saugat.recylerviewpresidentus.Activity.PresidentDetails;
import com.saugat.recylerviewpresidentus.Model.ModelPresident;
...
public class Adapter extends RecyclerView.Adapter<Adapter.ViewHolder>{
    ...
    public class ViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener{
        ...
        public void onClick(View v) {
            Intent intent = new Intent(context, PresidentDetails.class);
